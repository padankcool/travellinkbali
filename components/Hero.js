  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center px-6 max-w-5xl mx-auto mt-20">
        <span className="text-amber-400 text-xs md:text-sm tracking-[0.4em] uppercase mb-4 block font-medium">
          Premier Villa Management & Curated Stays in Bali
        </span>
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif text-white tracking-wider mb-6 leading-tight">
          Exceptional Properties. <br className="hidden md:block" /> Unmatched Management.
        </h1>
        <p className="text-neutral-200 text-sm md:text-base tracking-wide max-w-2xl mx-auto mb-10 font-light leading-relaxed">
          We transform Bali’s finest estates into high-yielding luxury assets while delivering extraordinary, soulful holiday sanctuaries for discerning travelers.
        </p>
