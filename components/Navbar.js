      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <a
              ...
              className="flex items-center justify-center w-10 h-10 rounded-full bg-emerald-600/80 hover:bg-emerald-600 text-white transition-all shadow-md"
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center justify-center w-10 h-10 rounded-full bg-neutral-800/60 hover:bg-neutral-800 border border-neutral-700 text-neutral-300 hover:text-white transition-all"
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-neutral-900/95 backdrop-blur-lg border-t border-neutral-800 shadow-xl py-6 px-6 flex flex-col space-y-4 text-center">
            ...
            <div className="flex justify-center items-center space-x-4 py-2 border-b border-neutral-800">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center justify-center w-10 h-10 rounded-full bg-neutral-800 border border-neutral-700 text-neutral-300"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                  </svg>
                  ...
                  <div className="absolute left-1/2 -translate-x-1/2 mt-2 w-44 bg-neutral-900 border border-neutral-800 rounded-xl shadow-2xl overflow-hidden py-1 z-50">
                    ...
                    {languages.map((lang) => (
                      <button
                        ...
                        onClick={() => changeLanguage(lang)}
                        className={`w-full flex items-center space-x-3 px-4 py-2.5 text-xs text-left transition-colors ${
                          currentLang === lang.name ? 'bg-amber-600/20 text-amber-400 font-semibold' : 'text-neutral-300 hover:bg-neutral-800'
                        }`}
                      >
            ...
            <Link href="#services" onClick={() => setMobileMenuOpen(false)} className="text-neutral-200 hover:text-amber-400 py-2 tracking-wider text-xs uppercase">Property Management</Link>
            <Link href="#about" onClick={() => setMobileMenuOpen(false)} className="text-neutral-200 hover:text-amber-400 py-2 tracking-wider text-xs uppercase">About Us</Link>
