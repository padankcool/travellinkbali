      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-3">
            <a href={airbnbUrl} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-full overflow-hidden hover:opacity-90 transition-all shadow-md bg-white" title="View Airbnb Profile">
            ...
            <Link href="/booking" className="px-6 py-2.5 text-xs font-medium tracking-widest uppercase bg-amber-600 text-white rounded-full hover:bg-amber-500 transition-all shadow-md">
              Book Stay
            </Link>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-neutral-900/95 backdrop-blur-lg border-t border-neutral-800 shadow-xl py-6 px-6 flex flex-col space-y-4 text-center">
            ...
            <Link href="/booking" onClick={() => setMobileMenuOpen(false)} className="text-neutral-200 hover:text-amber-400 py-2 tracking-wider text-xs uppercase">Our Villas</Link>
            <a href="#about" onClick={(e) => scrollToSection(e, 'about')} className="text-neutral-200 hover:text-amber-400 py-2 tracking-wider text-xs uppercase">About Us</a>
            <a href="#services" onClick={(e) => scrollToSection(e, 'services')} className="text-neutral-200 hover:text-amber-400 py-2 tracking-wider text-xs uppercase">Property Management</a>
            <a href="#contact" onClick={(e) => scrollToSection(e, 'contact')} className="text-neutral-200 hover:text-amber-400 py-2 tracking-wider text-xs uppercase">Contact</a>
            
            <Link href="/booking" onClick={() => setMobileMenuOpen(false)} className="w-full py-3 text-xs font-medium tracking-widest uppercase bg-amber-600 text-white rounded-full hover:bg-amber-500 transition-all mt-4">
              Book Stay
            </Link>
          </div>
        )}
