      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {servicesList.map((service, index) => (
            <div key={index} className="group relative h-[420px] rounded-3xl overflow-hidden border border-stone-200/50 shadow-2xl transition-all duration-500 hover:shadow-amber-500/20 hover:-translate-y-2">
              <img 
                src={service.image} 
                alt={service.title} 
